...
The previous version of this service used a stand‑in object for the database
...
class AdminActionRepository:
    ...
    # -- public API -------------------------------------------------------
    async def insert_admin_action(self, action: AdminAction) -> AdminAction:
...
class AdminService:
    ...
    # -- logging ----------------------------------------------------------
    async def log_action(self, admin_id: int, action_type: str, payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        await self.repo.insert_admin_action(action)
